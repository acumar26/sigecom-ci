<script src="<?php echo URL_JS ?>usuario/jsUsuario.js" ></script>
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue tabbable">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-asterisk"></i>Registro de usuarios</div>
                     </div>
                           ...
                           <div class="tab-content">
                              <div class="tab-pane active" id="1">
                               ...
                               <div class="tab-pane" id="0">
                                  ...
                                  <?php $this->load->view('config/usuario/ins_view');  ?>
