        ...
        <table class="table table-striped table-bordered table-hover" id="sample_2">
            ...
            <tbody>
                <?php foreach ($buscarEmpresas as $key => $listar) { ?>                
                 <tr  class="odd gradeX">                                 
                    <td>
                        <button class="green btn mini" onclick="editarEmpresas('<?php echo $listar['nidempresa'] ?>');" ><i class="icon-edit"  ></i> Editar</button>
                        <button class="purple btn mini" onclick="estadoEmpresas('<?php echo $listar['nidempresa'] ?>');" ><i class="icon-refresh"></i> Estado</button>
                    </td>
