...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <body class="login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="form-vertical login-form" action="http://www.keenthemes.com/preview/metronic/index.html">
                <h3 class="form-title">Acceder al sistema</h3>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-icon left">
                            <i class="icon-user"></i>
                            <input class="m-wrap placeholder-no-fix" type="text" placeholder="Ingrese su usuario" name="txt_usuario" id="txt_usuario"/>
                        </div>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-icon left">
                            <i class="icon-lock"></i>
                            <input class="m-wrap placeholder-no-fix" type="password" placeholder="Ingrese su contraseña" name="txt_contrasena" id="txt_contrasena"/>
                        </div>
                    </div>
                </div>
...
<!--            <form class="form-vertical forget-form" action="http://www.keenthemes.com/preview/metronic/index.html">
...
<!--            <form class="form-vertical register-form" action="http://www.keenthemes.com/preview/metronic/index.html">
                <h3 class="">Sign Up</h3>
        ...
        <script src="<?php echo URL_JS ?>login.js" type="text/javascript"></script>      
