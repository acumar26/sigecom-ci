...
<!--            <div class="row-fluid">
                <div class="span6">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>Minoristas</div>                           
                        </div>
                            ...
                            <div class="row-fluid">
                                <div class="span4">
                                    <div class="easy-pie-chart">
                                        ...
                                        <a class="title" href="#">Avance<i class="m-icon-swapright"></i></a>
                                    </div>
                                </div>
                                ...
                                <div class="span4">
                                    <div class="easy-pie-chart">
                                        ...
                                        <a class="title" href="#">Efectividad <i class="m-icon-swapright"></i></a>
                                    </div>
                                </div>
                                <div class="margin-bottom-10 visible-phone"></div>
                                <div class="span4">
                                    <div class="easy-pie-chart">
                                        ...
                                        <a class="title" href="#">Morosidad <i class="m-icon-swapright"></i></a>
                                    </div>
                                </div>                                
                            </div>
                            <div class="row-fluid">
                                <div class="span4">
                                    <div class="easy-pie-chart">
                                        <div class="number transactions"  data-percent="55"><span>+55</span>%</div>
                                        <a class="title" href="#">Contado<i class="m-icon-swapright"></i></a>
                                    </div>
                                </div>
                                <div class="margin-bottom-10 visible-phone"></div>
                                <div class="span4">
                                    <div class="easy-pie-chart">
                                        <div class="number visits"  data-percent="85"><span>+85</span>%</div>
                                        <a class="title" href="#">Rechazo <i class="m-icon-swapright"></i></a>
                                    </div>
                                </div>
                                <div class="margin-bottom-10 visible-phone"></div>
                                <div class="span4">
                                    <div class="easy-pie-chart">
                                        <div class="number bounce"  data-percent="46"><span>-46</span>%</div>
                                        <a class="title" href="#">Nivel de servicio <i class="m-icon-swapright"></i></a>
                                    </div>
                                </div>                                
                            </div>
                        </div>
                ...
                <div class="span6">
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>Mayoristas</div>                           
                        </div>
                        <div class="portlet-body">
...
<!--            <div class="row-fluid">
                 <div class="span6">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>Subdistribuidores</div>                           
                        </div>
                        <div class="portlet-body">
                ...
                <div class="span6">
                    <div class="portlet box yellow">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>Auto servicios</div>                           
                        </div>
                        <div class="portlet-body">
