...
(function(a) {
    a.extend(a.fn, {validate: function(b) {
        ...
        }, messages: {required: "Campo requerido", remote: "Por favor, corrija este campo", email: "No es una dirección válida de correo electrónico.", url: "Ingrese una URL válida", date: "Ingrese una fecha válida", dateISO: "Please enter a valid date (ISO).", number: "Ingrese un número válido.", digits: "Ingrese solo digitos", creditcard: "Ingrese un número de tarjeta de crédito válida", equalTo: "Los valores no coinciden.", maxlength: a.validator.format("Please enter no more than {0} characters."), minlength: a.validator.format("Ingrese al menos {0} caracteres."), rangelength: a.validator.format("Please enter a value between {0} and {1} characters long."), range: a.validator.format("Please enter a value between {0} and {1}."), max: a.validator.format("Please enter a value less than or equal to {0}."), min: a.validator.format("Please enter a value greater than or equal to {0}.")}, autoCreateRanges: !1, prototype: {init: function() {
                function d(b) {
